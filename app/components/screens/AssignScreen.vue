...
<template>
  <div class="screen">
    <div class="section-pad" style="padding-top: 8px; padding-bottom: 12px; display: flex; align-items: flex-start; justify-content: space-between; gap: 12px;">
      <div>
    ...
    <div class="section-pad">
      <div v-if="layout === 'cards'" style="display: flex; flex-direction: column; gap: 8px;">
        <div
          ...
          style="background: var(--paper); border-radius: 14px; padding: 12px 14px; border: 1px solid rgba(20,18,16,0.08); display: flex; align-items: center; gap: 12px;"
      ...
      <div
        ...
        style="background: var(--paper); border-radius: 14px; overflow: hidden; border: 1px solid rgba(20,18,16,0.12);"
      >
