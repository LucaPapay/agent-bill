...
<template>
  ...
  >
    <div
      ...
      class="flex h-8 w-8 shrink-0 items-center justify-center rounded-xl bg-[rgba(246,181,51,0.16)] text-[var(--marigold)]"
    >
      <IconGlyph name="sparkle" width="16" height="16" />
    </div>

    <div
      class="w-[min(100%,720px)] overflow-hidden rounded-3xl shadow-[0_20px_38px_rgba(24,16,10,0.18)] [&_.receipt-split-stage]:min-h-[320px]"
    >
      <ReceiptSplitPreview
        :image-src="imageSrc"
        :status="status"
