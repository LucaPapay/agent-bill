...
<template>
  ...
  >
    ...
    <path d="M15 19c0-2 1.8-3.5 4-3.5" />
  </svg>
  ...
  <svg
    ...
    fill="currentColor"
  >
    <path d="M12 2l1.8 5.6L19 9l-5.2 1.7L12 16l-1.8-5.3L5 9l5.2-1.4z" />
    <path d="M19 14l.9 2.5L22 17l-2.1.7L19 20l-.9-2.3L16 17l2.1-.5z" />
  </svg>
